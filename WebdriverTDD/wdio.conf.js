...
exports.config = {
    afterTest: async function (test, context, { error, result, duration, passed, retries }) {
        if (!passed) {
            await browser.saveScreenshot(`/Users/user/Desktop/WebDriverIO/WebdriverTDD/test/specs/errorShots/${test.fullTitle}.png`);
        }
    },
    ...
    cucumberOpts: {
        ...
        beforeFeature: function (uri, feature, scenarios) {
            console.log('Executing beforeFeature hook');
        },
        beforeScenario: function (uri, feature, scenario, sourceLocation) {
            console.log('Executing beforeScenario hook');
        },
        beforeStep: function ({ uri, feature, step }, context) {
            console.log('Executing beforeStep hook');
        },
        afterStep: function ({ uri, feature, step }, context, { error, result, duration, passed }) {
            console.log('Executing afterStep hook');
        },
        afterScenario: function (uri, feature, scenario, result, sourceLocation) {
            console.log('Executing afterScenario hook');
        },
        afterFeature: function (uri, feature, scenarios) {
            console.log('Executing afterFeature hook');
        },
        after: function (result, capabilities, specs) {
            console.log('Executing after hook');
        },
    ...
    //     }
    //     if (!passed) {
    //         await browser.saveScreenshot(`./errorShots/${test.fullTitle}.png`);
    //     }
    // },
    //
    // =====
